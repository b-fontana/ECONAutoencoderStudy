...
FPGA_IMPL = 2 #implementation=2 -> VU13P fpga || implementation=1 -> (older) KU15P fpga
process = custom_geometry_decentralized_V11(process, links='signaldriven', implementation=FPGA_IMPL) # LP: relevant (new) part of producer - implementation=2 -> VU13P fpga || implementation=1 -> (older) KU15P fpga
...
#stage2_algos = ['Histomax', 'Histomaxxydr015']
